...
from user_profile.models import UserProfile,EmailMe
...
class SignUpForm(forms.ModelForm):
   ...
   user_type = forms.ChoiceField(widget = forms.Select(attrs={'class':'form-control'}),choices = (USER_TYPE_CHOICES ))
...
class EmailMeForm(forms.ModelForm):
   class Meta:
      ...
      widgets={
        'to':forms.EmailInput(attrs={'class':'form-control','placeholder':'example@gmail.com'}),
        'subject':forms.TextInput(attrs={'class':'form-control','placeholder':'Enter Subject here..'}),
        'content':forms.Textarea(attrs={'class':'form-control','placeholder':'Say Something... '}),
      }
